...
-- ========================================
-- PASO 11: HABILITAR ROW LEVEL SECURITY (RLS SIMPLIFICADO)
-- ========================================
-- NOTA: RLS deshabilitado por defecto. 
-- Habilítalo manualmente desde el dashboard de Supabase si lo necesitas.
-- Las políticas se deben configurar según tu sistema de autenticación.

-- Comentadas por ahora - descomentar si usas RLS:
...
BEGIN
    ...
    RAISE NOTICE '⚠️  RLS deshabilitado por defecto (configúralo desde el dashboard si lo necesitas)';
    RAISE NOTICE '';
