-- ========================================
-- SISTEMA DE REPORTES - VERSIÓN SIMPLIFICADA Y FUNCIONAL
-- ========================================
-- Este script contiene SOLO las vistas que funcionan correctamente
-- Elimina vistas problemáticas relacionadas con gastos por categoría
-- ========================================

-- ========================================
-- LIMPIEZA: Eliminar objetos anteriores
-- ========================================
...
-- VISTA 5: Comparativo Financiero (Ingresos vs Gastos)
...
-- VISTA 6: Análisis Estacional de Productos
...
BEGIN
    ...
    RAISE NOTICE '📊 6 Vistas creadas (sin vista de gastos por categoría)';
    RAISE NOTICE '⚡ 3 Funciones dinámicas creadas';
    RAISE NOTICE '🚀 3 Índices de performance creados';
END $$;
