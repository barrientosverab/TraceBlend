    ...
    <div className="flex flex-col h-[calc(100vh-64px)] bg-stone-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filtrados.map(p => {
            ...
            return (
              <div key={p.id} className="bg-white p-4 rounded-xl border border-stone-200 shadow-sm hover:shadow-md transition-all group relative flex flex-col justify-between">
                <div>
                ...
                <div className="pt-3 border-t border-stone-100 flex justify-between items-end">
                   <button onClick={() => openEdit(p)} className="text-stone-400 hover:text-emerald-600 font-bold text-xs flex items-center gap-1">
